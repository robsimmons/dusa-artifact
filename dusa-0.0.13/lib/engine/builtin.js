import { BOOL_FALSE, BOOL_TRUE, expose, hide } from '../datastructures/data.js';
import { equal, match } from './dataterm.js';
export function* runBuiltinBackward(pred, prefix, matchPosition, postfix, value, substitution) {
...
export function runBuiltinForward(pred, args) {
    switch (pred) {
        case 'BOOLEAN_FALSE':
            return BOOL_FALSE;
        case 'BOOLEAN_TRUE':
